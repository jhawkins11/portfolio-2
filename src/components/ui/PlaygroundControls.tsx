            ...
            <div className='space-y-4'>
                    ...
                    <div>
                      ...
                      <div className='flex items-center gap-2'>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleColorChange('sphere', 'color', e.target.value)
                          }
                    ...
                    <div>
                      ...
                      <div className='flex items-center gap-2'>
                        <div
                          ...
                          onClick={() =>
                            setColorPickerOpen(
                              colorPickerOpen === 'emissive' ? null : 'emissive'
                            )
                          }
                        />
                        <input
                  ...
                  <div>
                    ...
                    {colorPickerOpen === 'primaryBlob' && (
                      <ColorPickerWrapper
                        ...
                        onChange={(color) =>
                          handleColorChange('background', 'primaryBlob', color)
                        }
                        onClose={closeColorPicker}
                      />
                    )}
                  ...
                  <div>
                    ...
                    {colorPickerOpen === 'accentBlob' && (
                      <ColorPickerWrapper
                        ...
                        onChange={(color) =>
                          handleColorChange('background', 'accentBlob', color)
                        }
                        onClose={closeColorPicker}
                      />
                    )}
              ...
              {activeTab === 'shapes' && (
                <div className='w-full p-4'>
                  <h3 className='text-lg font-semibold mb-3'>Custom Shapes</h3>
                  ...
                  <div className='mt-6 bg-gray-100 dark:bg-gray-800 p-3 rounded text-sm'>
                    <p>
                      Draw shapes to create unique 3D objects that will appear
                      in your scene!
                    </p>
                  </div>
                </div>
